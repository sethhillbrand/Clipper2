...
namespace Clipper2Lib {
  ...
  inline Paths64 DoRectClip(const Rect64& rect,
  ...
  inline PathsD DoRectClip(const RectD& rect,
  ...
  {
    return DoRectClip(rect, PathsD{ path }, convex_only, precision);
  }

  inline Paths64 DoRectClipLines(const Rect64& rect, const Paths64& lines)
  {
  ...
  inline Paths64 DoRectClipLines(const Rect64& rect, const Path64& line)
  {
    return DoRectClipLines(rect, Paths64{ line });
  }

  inline PathsD DoRectClipLines(const RectD& rect, const PathD& line, int precision = 2)
  {
    return DoRectClip(rect, PathsD{ line }, precision);
  }

  inline PathsD DoRectClipLines(const RectD& rect, const PathsD& lines, int precision = 2)
  {
